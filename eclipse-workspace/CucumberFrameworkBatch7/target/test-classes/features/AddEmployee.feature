...
Feature: Add Employee
  ...
  Scenario: Add employee with login details
    And enter first and last name
    Then check login details checkbox
  ...
  Scenario Outline: Adding multiple employees without login details
    When enteremployee "<First Name>","<Middle Name>" and "<Last Name>"
    Then click on save Button
    ...
    Examples: 
      ...
      @dtWithHEader
      Scenario: Adding multiple emlpoyees at one ececution
      ...
      @excelTask
     Scenario: Addind multiple employees from excel file
