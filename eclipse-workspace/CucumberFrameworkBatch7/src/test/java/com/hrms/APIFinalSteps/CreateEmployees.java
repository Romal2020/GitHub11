...
public class CreateEmployees {
	...
	public void employee_data_provided_is(String employeeFirstName, String employeeLastName, String employeeMiddleName,
		...
		request = APICommonMethods.createEmployeeRequest(GenerateTokenSteps.token, APIPayloadCommonMethods.createEmployeePayloadMoreDynamic(employeeFirstName,
				 employeeLastName, employeeMiddleName, employeeGender, employeeBirthday, employeeJobStatus, employeeJobTitle));
	}
