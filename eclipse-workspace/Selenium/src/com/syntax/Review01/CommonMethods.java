...
public class CommonMethods {
	...
	public static final String Syntaxpractice_URl ="http://jiravm.centralus.cloudapp.azure.com:8081/index.html";
	...
	public static void setUp(String browser, String url){
		...
		if(browser.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\Romal\\eclipse-workspace\\Selenium\\Drivers\\geckodriver.exe");
