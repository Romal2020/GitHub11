...
public class MethodsWithReturn {
	...
	//create method that will accept an int value and return whether number is even
	...
	//create a method that will accept String value and return that value all in upperCase
