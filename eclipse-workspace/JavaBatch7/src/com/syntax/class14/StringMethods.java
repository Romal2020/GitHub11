...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		String greethings = " Hello Syntax ";
		int sizeOfDifferentString = greethings.length();
		...
		// +with nunmbers serves as arithmetic operator
		...
		String dog = "      my god name      charly";
		System.out.println("------before trimming--------");
		System.out.println(cat);
		System.out.println(dog);
		
		System.out.println("-----After tramming-------");
